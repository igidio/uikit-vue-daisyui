...
<template>
  <div class="flex flex-col h-full">
    <div
      class="flex items-center justify-between pb-4 md:pb-5 border-b border-base-300 shrink-0 p-4"
    >
      <slot name="header">
    ...
    <div
      v-if="show_footer"
      class="flex items-center justify-end gap-2 pt-4 md:pt-5 border-t border-base-300 shrink-0 p-4"
    >
      <slot name="footer">
